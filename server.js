...
function mongoConnect() {
    return new Promise((resolve, reject) => {
    var mongoURL = process.env.CATALOGUE_MONGO_URL || 'mongodb://username:password@mongodb:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false';
